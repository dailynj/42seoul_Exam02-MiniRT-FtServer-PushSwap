...
/*   Updated: 2021/01/12 22:36:05 by honlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				square_rotate(t_data_square *data)
{
	...
	ra_x = atan2(data->nor.z, data->nor.y) -
			atan2(data->center.z, data->center.y);
	...
	ra_y = atan2(data->nor.x, data->nor.z) -
			atan2(data->center.x, data->center.z);
	...
	ra_z = atan2(data->nor.y, data->nor.x) -
			atan2(data->center.y, data->center.x);
...
double				square_hit(void *data, t_vec origin, t_vec u_dir)
{
	...
	t = (vec_dot(n, ((t_data_square *)data)->center) -
