...
/*   Updated: 2021/05/12 00:52:26 by najlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int        sp_parse(t_cntl *cntl, char **one_line)
{
    ...
    obj_add_back(&cntl->scene->world, object(SP, sphere(point3(ft_atoi(tmp[0]), ft_atoi(tmp[1]), ft_atoi(tmp[2])), 
            ft_atof(one_line[2])), color(ft_atoi(tmp2[0])/255.0, ft_atoi(tmp2[1])/255.0, ft_atoi(tmp2[2])/255.0)));
    free(tmp);
    free(tmp2);
...
int        pl_parse(t_cntl *cntl, char **one_line)
{
    ...
    obj_add_back(&cntl->scene->world, object(PL, plane(point3(ft_atoi(tmp[0]), ft_atoi(tmp[1]), ft_atoi(tmp[2])), 
            vec(ft_atoi(tmp2[0]), ft_atoi(tmp2[1]), ft_atoi(tmp2[2]))), color(ft_atoi(tmp3[0])/255.0, ft_atoi(tmp3[1])/255.0, ft_atoi(tmp3[2])/255.0)));
    free(tmp);
    free(tmp2);
    free(tmp3);
...
int        sq_parse(t_cntl *cntl, char **one_line)
{
    ...
    obj_add_back(&cntl->scene->world, object(SQ, square(point3(ft_atoi(tmp[0]), ft_atoi(tmp[1]), ft_atoi(tmp[2])), 
            vec(ft_atoi(tmp2[0]), ft_atoi(tmp2[1]), ft_atoi(tmp2[2])), ft_atof(one_line[3])), 
...
int        cy_parse(t_cntl *cntl, char **one_line)
{
    ...
    obj_add_back(&cntl->scene->world, object(CY, cylinder(point3(ft_atoi(tmp[0]), ft_atoi(tmp[1]), ft_atoi(tmp[2])), 
            vec(ft_atoi(tmp2[0]), ft_atoi(tmp2[1]), ft_atoi(tmp2[2])), ft_atof(one_line[3]), ft_atof(one_line[3])), 
            color(ft_atoi(tmp3[0])/255.0, ft_atoi(tmp3[1])/255.0, ft_atoi(tmp3[2])/255.0)));
    free(tmp);
    free(tmp2);
    free(tmp3);
...
int        tr_parse(t_cntl *cntl, char **one_line)
{
    ...
    obj_add_back(&cntl->scene->world, object(TR, triangle(point3(ft_atoi(tmp[0]), ft_atoi(tmp[1]), ft_atoi(tmp[2])), 
